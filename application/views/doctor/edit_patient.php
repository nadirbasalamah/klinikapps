...
<head>
  ...
  <title>
    Edit Patient's Nutrition Record
  </title>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#">Ubah Data Gizi Pasien</a>
          </div>
              ...
              <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="angka_tb_bb" value=<?php echo $rec->angka_tb_bb;?> required>
                    </div>
                  </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                      ...
                      <img src="<?php echo base_url('graph_pictures/' . $rec->gambar_tb_bb);?>" id="image-preview" alt="Default Image" width="360" height="240"/>
                      <br/>
          ...
          <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                      <label class="bmd-label-floating">Angka</label>
                      <input type="number" class="form-control" name="angka_bb_u" value=<?php echo $rec->angka_bb_u;?> required>
                    </div>
                  </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                      <br><label>Upload Image</label><br>
                      <div style="padding:10px;margin-left:-10px;  " container>
                      <img src="<?php echo base_url('graph_pictures/' . $rec->gambar_bb_u);?>" id="image-preview2" alt="Default Image" width="360" height="240"/>
                      <br/>
          ...
          <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                      <label class="bmd-label-floating">Angka</label>
                      <input type="number" class="form-control" name="angka_tb_u" value=<?php echo $rec->angka_tb_u;?> required>
                    </div>
                  </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                      <br><label>Upload Image</label><br>
                      <div style="padding:10px;margin-left:-10px;  " container>
                      <img src="<?php echo base_url('graph_pictures/' . $rec->gambar_tb_u);?>" id="image-preview3" alt="Default Image" width="360" height="240"/>
                      <br/>
          ...
          <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                      <label class="bmd-label-floating">Angka</label>
                      <input type="number" class="form-control" name="angka_imt_u" value=<?php echo $rec->angka_imt_u;?> required>
                    </div>
                  </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                      <br><label>Upload Image</label><br>
                      <div style="padding:10px;margin-left:-10px;  " container>
                      <img src="<?php echo base_url('graph_pictures/' . $rec->gambar_imt_u);?>" id="image-preview4" alt="Default Image" width="360" height="240"/>
                      <br/>
          ...
          <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                      <label class="bmd-label-floating">Angka</label>
                      <input type="number" class="form-control" name="angka_hc_u" value=<?php echo $rec->angka_hc_u;?> required>
                    </div>
                  </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                      <br><label>Upload Image</label><br>
                      <div style="padding:10px;margin-left:-10px;  " container>
                      <img src="<?php echo base_url('graph_pictures/' . $rec->gambar_hc_u);?>"  id="image-preview5" alt="Default Image" width="360" height="240"/>
                      <br/>
