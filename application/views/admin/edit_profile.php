                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div style="padding:10px; " container>
                            ...
                            <img src="<?php echo base_url('assets/profile_pictures/' . $profile_picture);?>" id="admin-profile-picture-preview" alt="Profile Picture" width="360" height="240"/>
                      <br/>
                        <input type="file" name="profile_picture" id="admin-profile-picture-source" onchange="previewImage('admin-profile-picture-preview','admin-profile-picture-source');"/>
                   </div>
                    </div>
                    <div class="row">
