                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div style="padding:10px; " container>
                            ...
                            <img src="<?php echo base_url('assets/profile_pictures/' . $profile_picture);?>" id="doctor-profile-picture-preview" alt="Profile Picture" width="360" height="240"/>
                      <br/>
                        <input type="file" name="profile_picture" id="doctor-profile-picture-source" onchange="previewImage('doctor-profile-picture-preview','doctor-profile-picture-source');"/>
                   </div>
                    </div>
                    <div class="row">
